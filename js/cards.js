...
const CARDS = [
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "+1 к силе атаки. Если вы убиваете в этой атаке, то все эффекты и стойка цели по вашему желанию переходят вам, а не в сброс.",
    img: "cards/card_todo.png"
  },
  {
    id: 1083,
  ...
  },
  {
    ...
    icons: ["charges"],
    tags: ["draft"],
    desc: "Остальные активные игроки скидывают карту оружия или жетон жизни. TODO: rework",
    img: "cards/card_todo.png"
  },
  {
    id: 1091,
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Можете сбросить эту карту совместно с другими (максимум 3). За каждую сброшенную карту, включая эту, берёте новую карту из колоды. TODO: remove this card entirely?",
  ...
  },
  {
    ...
    icons: ["hpctx"],
    tags: [],
    desc: "Восстановите все недостающие жетоны стойкости. Другой игрок на ваш выбор берёт одну карту из колоды. -ИЛИ- {При полном здоровье} Возьмите две карты из колоды.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Заставьте игрока при смерти выложить все карты на стол, и можете забрать любые две из них. После карты опять скрываются. TODO: нет действия на живых?",
