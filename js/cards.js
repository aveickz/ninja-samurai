...
const CARDS = [
  ...
  },
  {
    ...
    icons: ["charges"],
    tags: [],
    desc: "Выбранный игрок скидывает все эффекты. За каждый сброшенный эффект вы можете восстановить жизнь или взять карту из колоды. TODO: объединить чашу и палочку через spare charges?",
  ...
  },
  {
    ...
    desc: "Союзники не участвуют в групповых картах противника — групповая карта не считает союзников активными для своего эффекта." +
          "[NL]{Носитель:} сам подвержен групповым картам как обычно — он стоит в центре дыма и принимает удар на себя. TODO: share every carD? somehow{}:",
    img: "cards/card_95_zavesa_dyma.png"
  },
  {
    id: 2206,
    ...
    icons: [],
    tags: ["draft"],
    desc: "{Враги} не могут атаковать дальше дистанции 1. TODO:(и убрать пыль в глаза).?",
    img: "cards/card_todo.png"
  },
  {
    id: 1207,
