...
const CARDS = [
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Вы находитесь дальше от всех на 1 при атаках по вам. Ваши атаки могут достать дальше на 1.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Каждый раз при прямой атаке по вам снижаете урон на один. Дополнительно можете скинуть карту с руки за каждое снижение урона (не менее 1).",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "При совершении атаки можете выбрать нанести одну рану больше {ИЛИ} взять одну карту из колоды.[NL]{Совершая успешно прямую атаку} восстановите себе 1 жетон здоровья.",
  ...
  // ── ЭФФЕКТЫ постоянные/разовые (стр. 13–14) ──────────────────────
  {
    ...
    icons: [],
    tags: [],
    desc: "Все атаки по вам наносят на одну рану больше.[NL]{Убивший вас игрок} берёт две карты из колоды.",
  ...
  },
  {
    ...
    icons: ["charges"],
    tags: [],
    desc: "Выбранный игрок скидывает указанный вами эффект. За каждую дополнительно сброшенную карту можно скинуть ещё 1 эффект. За каждый такой скинутый эффект, вы восстанавливаете 1 жетон здоровья любому игроку.",
  ...
  },
  {
    ...
    icons: ["rolectx"],
    tags: [],
    desc: "{Самурай} может обезвредить ловушку, скинув 1 жетон здоровья.[NL]{Ниндзя} может украсть ловушку.[NL]Вне зависимости от роли, можете скинуть эту карту, чтобы взять две новых из колоды.",
