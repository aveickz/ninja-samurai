...
const CARDS = [
  ...
  },
  {
    ...
    icons: ["poison"],
    tags: ["poison"],
    desc: "Все прямые атаки {союзников} оружием автоматически отравлены, как будто использовалось ядовитое оружие.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "{Враги} после нанесения ран прямой атакой по вашим союзникам получают от носителя ауры 1 рану.",
