...
const CARDS = [
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Сыграв эту карту, возьмите по 1 карте из колоды за каждый недостающий жетон здоровья.[NL]{Если вы отравлены}, возьмите дополнительно 1 карту ко всему добору.",
