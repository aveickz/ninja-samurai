...
const CARDS = [
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ЛОВУШКА. Атака не проходит, защищающийся берёт 2 карты из колоды.",
  ...
  },
  {
    ...
    icons: ["poison"],
    tags: ["poison"],
    desc: "ЛОВУШКА. Атакующий отравляется ядом, но если он уже отравлен, то вы наносите ему три раны.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ЛОВУШКА. Вы оскорбляете атакующего. Иногда это хуже смерти :)",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ЗАЩИТА ~ Вы можете выбрать столько ран вы хотите получить при атаке, и за каждую рану берёте карту из колоды.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ЗАЩИТА ~ Вы также забираете у атакующего случайную карту.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ЗАЩИТА. Атака не проходит и обращается обратно, равная базовой силе оружия. Атакующий может защититься от рикошета.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "МОДИФИКАТОР ~ Ваша атака игнорирует ловушки и от неё невозможности защититься.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "МОДИФИКАТОР ~ Дальность вашей атаки увеличивается на 2.",
  ...
  },
  {
    ...
    icons: [],
    tags: ["trash"],
    desc: "МОДИФИКАТОР ~ От вашей атаки невозможно защититься, однако ловушки продолжают действовать. (ушло в удар тени)",
  ...
  },
  {
    ...
    icons: [],
    tags: ["trash"],
    desc: "МОДИФИКАТОР ~ Атака наносит удар по двум целям одновременно. Однако сила и дальность снижаются на один. WAY TOO COMPLICATED",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "МОДИФИКАТОР ~ Делает атаку метательной на любом расстоянии, но финальная сила атаки становится равна единице.",
  ...
  },
  {
    ...
    icons: [],
    tags: ["trash"],
    desc: "МОДИФИКАТОР ~ От вашей атаки невозможно защититься, и ловушки не действуют. (ушло в удар тени)",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "МОДИФИКАТОР ~ Ваша атака оружием полностью игнорирует все бонусы от стойки, персонажа и эффектов цели.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "МОДИФИКАТОР ~ Сила атаки увеличивается на 2.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ПОСТОЯННЫЙ эффект. Выбранный игрок берёт на одну карту больше в фазе набора.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Либо сыграйте эту карту, чтобы взять три новых из колоды, либо оставьте, чтобы получить победное очко.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "В открытую передайте эту карту любому активному игроку, в замен он обязан вам дать одну карту по свою желанию в закрытую. Если игрок умирает с этой картой на руках, положите её поверх колоды.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ВМЕШАТЕЛЬСТВО. Уничтожает сыгранное оружие на столе, карта идёт в сброс, а атака отменяется.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "ВМЕШАТЕЛЬСТВО. Следующее действие выбранного игрока завершит его ход. Сюда не входит скидывание парных карт.",
