...
const CARDS = [
  ...
  },
  {
    ...
    icons: ["rolectx"],
    tags: [],
    desc: "Ваша атака игнорирует ловушки и от неё невозможности защититься.[NL]{Ниндзя} наносят на 1 рану больше.[NL]{Самураи} штрафуются сбросом карты.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "+1 к силе атаке. Если вы убиваете в этой атаке, то все эффекты и стойка цели по вашему желанию переходят вам, а не в сброс.",
    img: "cards/card_todo.png"
  },
  ...
  },
  {
    ...
    icons: ["charges"],
    tags: [],
    desc: "Каждый враг получает атаку равную по силе количеству ваших обескровленных союзников. От этого нельзя защититься.",
    img: "cards/card_todo.png"
  },
  {
    id: 1094,
    title: "?Эставфета мечей?",
    types: ["aoe"],
    qty: 1,
    group: "aoe",
    icons: [],
  ...
  },
  {
    ...
    icons: [],
    tags: ["draft"],
    desc: "TODO: Следующий игровой ход выбранный игрок будто обескровлен. ЧТО-ТО сделать с этой картой! Может в стойку из вмешательства?",
  ...
  },
  {
    ...
    icons: ["hpctx"],
    tags: [],
    desc: "Любой выбранный активный игрок восстанавливает 2 жетона жизни. {На пороге вашей смерти} вы можете вылечить другого игра на 3 жизни.",
  ...
  },
  {
    ...
    icons: ["rolectx"],
    tags: [],
    desc: "{Самурай} может обезвредить ловушку и взять 1 карту из колоды или восстановить 1 жизнь. TODO: или ценой 1 раны?. [NL]{Ниндзя} может украсть ловушку.[NL] Вне зависимости от роли, можете скинуть эту карту, чтобы взять две новых из колоды.",
  ...
  },
  {
    ...
    icons: ["rolectx"],
    tags: [],
    desc: "Количество жетонов жизни выбранного игрока становится равно вашему. TODO: ninja 1 spare card",
  ...
  },
  {
    ...
    icons: ["hpctx"],
    tags: [],
    desc: "Восстановите все недостающие жетоны стойкости. Другой игрок на ваш выбор берёт одну карту из колоды. TODO: FULL HP",
  ...
  },
  {
    ...
    icons: ["rolectx"],
    tags: [],
    desc: "Вы меняетесь с выбранным игроком количеством жетонов жизни. TOOD: samu 1 spare card",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Сыграв эту карту, возьмите по 1 карте из колоды за каждую полученную рану.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Заставьте обескровленного игрока выложить все карты на стол, и можете забрать любую из них. После карты опять скрываются.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Сыграйте эту карту, чтобы вызвать действия {при смерти} персонажа любого игрока.",
    img: "cards/card_todo.png"
  },
  {
    id: 1124,
  ...
  },
  {
    ...
    icons: ["hpctx", "rolectx"],
    tags: [],
    desc: "Сыграйте эту карту, чтобы перенаправить прямую атаку оружия на себя.[NL]На пороге вашей смерти} выши союзникиКаждый союзники берут по 1 карте из колоды.[NL]{Самураи} при этом получают на одну рану меньше.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Объявляете один из четырёх типо карт: Оружие, Ловушка, Стойка или Защита. Берёте из сброса в обратном порядке первую попавшуюся этого типа.",
  ...
  // ── ПЕРСОНАЖИ (стр. 19) ───────────────────────────────────────────
  {
    ...
    desc: "Каждый раз, получая раны, вы берёте одну карту из колоды. Вместо вынужденного сброса карты можно тратить жетон жизни." +
          "[NL]{При смерти} враги получают 1 рану.",
  ...
  },
  {
    ...
    desc: "В фазе набора вы берёте дополнительную карту и можете брать из сброса. " +
          ...
          "[NL]{При смерти} ваши союзники берут по одной карту из колоды.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "TODO:Вашу стойку не могут украсть или сбросить. TODO: Draw? TODO: also somehow link with players with active stance" +
          "[NL]{При смерти} вы не теряете стойку, а все союзники с выставленной стойкой TODO: full heal/draw (+2?)",
  ...
  },
  {
    ...
    desc: "Вы можете использовать оружие для защиты от прямых атак, но при этом получаете одну рану. Можете скидывать карты защиты, чтобы взять две новых из колоды." +
          "[NL]{При смерти} можете отдать каждому союзнику по одной карте защиты в открытую.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Ваши ловушки не могут обезвредить, украсть или просветить. Раз в ход вы можете сбросить карту, чтобы просветить любую ловушку на столе. TODO: DRAW? TODO: some how link with players that have ACtive trap?" +
          "[NL]{При смерти} ловушки врагов просвещаются.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "Раз в ход вы можете забрать на усмотрение случайную карту игрока, отдав свою взамен в закрытую. Раз в ход вы можете сбросить три карты, чтобы взять две новых из колоды." +
          "[NL]{При смерти} TODO",
  ...
  },
  {
    ...
    desc: "Можете сбросить карту оружия раз за ход, чтобы восстановить жизнь любому игроку или взять две карты из колоды." +
          "[NL]{При смерти} может отдать каждому союзнику по одной карте оружия в открытую.",
  ...
  },
  {
    ...
    icons: [],
    tags: [],
    desc: "За каждый восстановленный жетон жизни ею другим и за каждый восстановленный себе берёт карту из колоды. Может перенаправить лечебный эффект с себя на союзника." +
          "[NL]{При смерти} каждый союзник восстанавливает 1 жетон жизни, не давая вам карты из колоды.",
    img: "cards/card_145_manase.png"
  },
  {
    id: 145,
    title: "Минамото",
    subtitle: "Дух оспы Идзу/Стрелок-изгнанник",
    hp: 5,
    types: ["character"],
    qty: 1,
    group: "character",
    icons: [],
    tags: [],
    desc: "TODO: +1 карта в фазе набора за каждого отравленного игрока на столе. TODO: Sepcial." +
          "[NL]{При смерти}Все враги отравляются ядом, а союзники исцеляются от яда.",
    img: "cards/card_todo.png"
  },
  ...
  // №6 и mechanics/team_cards_ideas.html.
  {
    ...
    desc: "Все атаки союзников наносят +1 рану." +
          "[NL]{Носитель:} атаки самого носителя не получают +1 — знамёнщик командует, не дерётся.",
    img: "cards/card_todo.png"
  },
  {
    id: 1201,
    ...
    icons: [],
    tags: ["draft"],
    desc: "Все союзники получают −1 урон от каждой атаки (минимум 1)." +
          "[NL]{Носитель:} сам не получает −1 урон — стоит в центре строя, спину никто не прикрывает.",
    img: "cards/card_todo.png"
  },
  {
    id: 1202,
    ...
    icons: [],
    tags: ["draft"],
    desc: "Союзники не учитывают дистанцию между собой — между двумя любыми игроками одной команды считается нулевая дистанция." +
          "[NL]{Носитель:} сам учитывает дистанцию обычным образом — он стоит как маяк ритма, а не двигается с войском.",
    img: "cards/card_todo.png"
  },
  {
    id: 1203,
    ...
    icons: ["poison"],
    tags: ["draft", "poison"],
    desc: "Все атаки союзников оружием автоматически отравлены, как будто использовалось ядовитое оружие." +
          "[NL]{Носитель:} атаки самого носителя яд не накладывают — он несёт бочку, а не клинок в ней." +
          "[NL]Переосмысление групповой Бочки зловония (id=88) в командную.",
  ...
  },
  {
    ...
    icons: [],
    tags: ["draft"],
    desc: "Любой союзник может разыграть карту защиты с руки как вмешательство в защиту другого союзника. Бонусы карты защиты при этом не сохраняются — только базовое блокирование." +
          "[NL]{Носитель:} в его защиту союзники не могут разыграть защиту-вмешательство — он держит фронт, помочь ему некому.",
    img: "cards/card_todo.png"
  },
  {
    id: 1205,
    ...
    desc: "В фазе набора каждый союзник берёт +1 карту из колоды." +
          "[NL]{Носитель:} берёт стандартные 3 карты в фазе набора — раздаёт ресурс, себе не оставляет.",
    img: "cards/card_todo.png"
  },
  {
    id: 1206,
    ...
    icons: [],
    tags: ["draft"],
    desc: "Союзники не участвуют в групповых картах противника — групповая карта не считает союзников активными для своего эффекта." +
          "[NL]{Носитель:} сам подвержен групповым картам как обычно — он стоит в центре дыма и принимает удар на себя.",
    img: "cards/card_95_zavesa_dyma.png"
  },
  {
    id: 2206,
    ...
    icons: [],
    tags: ["draft"],
    desc: "TODO: враги не могут атаковать дальше дистанции 1. (и убрать пыль в глаза).",
    img: "cards/card_95_zavesa_dyma.png"
  },
  {
    id: 1207,
    ...
    icons: [],
    tags: ["draft"],
    desc: "Любой живой союзник может по согласию принять прямую атаку оружия по другому союзнику на себя (как Подвиг), но получает на 2 раны больше." +
          "[NL]{Носитель:} не может перенаправлять атаки на других союзников — он олицетворяет долг, а не делегирует его. Атаки по нему союзники могут перенаправить на себя; он сам — нет.",
    img: "cards/card_todo.png"
  },
  {
    id: 1208,
    ...
    icons: [],
    tags: ["draft"],
    desc: "Все союзники иммунны к отравлению ядом. Существующее отравление снимается в момент выкладывания карты." +
          "[NL]{Носитель:} сам уязвим к яду как обычно — он раздаёт травы команде, для себя ничего не оставляет.",
    img: "cards/card_todo.png"
  },
  {
    id: 1209,
    ...
    icons: [],
    tags: ["draft"],
    desc: "Все враги, после нанесения ран прямой атакой по вашим союзникам получают от носителя ауры 1 рану.",
