...
# ловушка левого игрока — рубашка вверх портретом с фигуркой макибиси (355,488), ровно над
# его персонажем и ролью (tools/compose-table-trap.py; прежний капкан боком — obsolete/table-v3-beartrap.webp).
...
LABELS = [
    ...
    ('trap',      (355, 405), (355, 452)),    # над ловушкой левого игрока — она портретом над персонажем и ролью
    ('character', (470, 445), (383, 548)),    # верхняя левая четверть, стрелка к правому краю персонажа
