...
# ловушка левого игрока — рубашка с капканом (330,470).
...
# превью 48.webp; слои строились в 4× и поворачивались до уменьшения.
LABELS = [
    ...
    ('trap',      (345, 398), (335, 448)),    # над ловушкой левого игрока
    ('character', (455, 450), (365, 532)),    # верхняя левая четверть
    ...
    ('defense',   (840, 650), (815, 688)),    # карта защиты у атаки
