...
CH = {
 ...
 'setup':         dict(layout={0: 'fan', 6: 'fan'}, icons=[],   # сердце и очко стоят у своих подзаголовков (INLINE)
                       cards={0: [201, 200, 'back-role'], 6: [137, 135, 'back-character']}),   # роли и их рубашка — у «Распределения ролей», персонажи и их рубашка — у «Выбора персонажей»; рубашка последней — сверху, видна целиком
 ...
 'traps':         dict(icons=[[('ic','trap')]],                         cards=[43, 41], fig=('trap-fig', 16, 1, 4)),   # фигурка макибиси тушью — в углу главы, чуть левее края
 ...
 'auras':         dict(icons=[[('ic','aura')]],                        cards=[1209, 1206], fig=('banner-fig', 16, 2, 0, 12)),   # «Часовой» внутри, «Дымовая завеса» сверху; фигурка знамени тушью — в углу, опущена на 12 мм ниже карт
