...
CH = {
 ...
 'turn':          dict(layout={0: 'fan', 3: 'fan'}, icons=[],
                       cards={0: [109, 84], 3: ['back', 'back']}),   # у хода — действие «Саке» и групповое «Чайная церемония» сверху; у «Набора карт» — две рубашки
...
PAGES = [
    ...
    [('turn', 0, 3), ('turn', 3, None), 'death'],   # ход; набор карт и восстановление — со своими рубашками; смерть
