...
плюс пример вмешательства союзника: левый ниндзя кладёт «Исцеление» к центру стола, в сторону
атакуемого правого ниндзя. Карты повёрнуты как остальные карты своего игрока (верх — к центру стола).
...
# левый игрок: верх карт — вправо (к центру), поворот на 90° по часовой; вмешательство — к центру стола
paste_center(im, down(rot(card_face('rules/media/cards/121.webp'), -90)), 600, 652)  # «Исцеление» союзника — под колодой, левее атаки
